...
@section('main')
    <div class="container-fluid">
        <div class="row">
            @if(Auth::user()->can_trade === \App\User::CAN_TRADE)
                ...
                <section id="sell" class="col-md-6">
                    ...
                    <div class="background" id="sellBackground">
                        <svg viewbox=" 0 0 100 100">
                            <line x1="0%" y1="95%" x2="0%" y2="100%"
                                  style="stroke:rgb(242,201,2);stroke-width:2"></line>
                    ...
                    <div id="sellPostSubmitView">
                        ...
                        <div>
                            <button class="btn btn-order closePostViewButton"
                                    data-type="sell">{{__('Zatvori')}}</button>
                        </div>
                    </div>
                </section>
            @else
                <section class="col-md-6" id="buy"></section>
                <section class="col-md-6" id="sell">
                    <h2>{{__('Zabrana na trgovanje')}}</h2>
                    <p>{{__('Vaše trgovanje kriptovalutama je onemogućeno od strane Administratora.')}}</p>
                    <a href="{{URL::to('/messages')}}"
                       class="btn btn-yellow">{{__('Pošalji poruku Administratoru')}}</a>
                </section>
            @endif
        </div>
        <div class="row">
